...
- Add `OperationKind` registry table with committed/reserved dispositions, including reserved `agent-send`; keep `spawn` as one kind and put spawn variants in payload `target_spec.shape`.
