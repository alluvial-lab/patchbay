...
Fix two stale PROTOCOL.md assertions that contradict current HEAD, and audit emitted TLA+ files for any prose presenting them as independent evidence.
