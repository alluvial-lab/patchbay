...
- **Disk note:** ENOSPC hit at 2026-08-15 ~02:20 — root cause this session: `target/debug/incremental` 31G + reviewer /tmp worktrees 5.6G + test-tmp 1.5G. Cleaned → 42G free. Watch incremental growth (~2G/fix-round); clear at wave boundaries when >15G.
