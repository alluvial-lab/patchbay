...
import {
  AdapterCapabilitySchema, AdapterDiagnosticReportingCapabilitySchema,
  AdapterSnapshotSupport, AdapterTargetCategory, AttachmentMethodSchema,
  FailureCode, IdempotencyStrength, PayloadContentType,
  ResourceCapabilitySchema, ResourceKindSchema, ResourceProjectionContractSchema,
  SchemaDescriptorSchema, type AdapterCapability,
...
export function tokenCommuneCapabilityManifest(): AdapterCapability {
  return create(AdapterCapabilitySchema, {
    ...
    idempotencyStrength: IdempotencyStrength.NONE,
