...
Patchbay uses `.work/` for operational coordination and `.research/` for grounded research.

- Do not hand-edit lifecycle fields to mimic completed work. Advance stages only as the relevant workflow act permits.
- Keep `.research/` source-grounded. Every citation must resolve to an attestation.
- Keep `.work/` operational. Track design/implementation/review steps as items; cite research via `research_refs:` rather than copying research claims into task prose without attribution.
