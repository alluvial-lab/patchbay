...
Summary: 48 modeled properties (8 promoted, 40 draft), 3 reserved-unmodeled stated-normative properties, 0 properties with promoted vector coverage.
...
Summary: 36 vector(s), 0 promoted vector(s), 0 checked-normative properties requiring promoted-vector coverage. Current checked-normative coverage gate is empty by design.
